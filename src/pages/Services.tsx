...
import { Hammer, Wrench, Settings, Gauge, CheckCircle, Flame, RotateCcw, Zap, Disc, ArrowRight, Thermometer, Cog, Scissors, FileCheck } from 'lucide-react';
...
const Services = () => {
  ...
  const processSteps = [
    {
      icon: Thermometer,
      title: 'Heating',
      description: 'Material heated to 1000-1200°C in controlled atmosphere furnaces'
    },
    {
      icon: Scissors,
      title: 'Cutting',
      description: 'Precise cutting of raw materials to required dimensions'
    },
    {
      icon: Hammer,
      title: 'Forging',
      description: 'Hot forging using specialized equipment and dies'
    },
    {
      icon: Cog,
      title: 'Machining',
      description: 'Precision machining to achieve final dimensions'
    },
    {
      icon: Gauge,
    ...
    },
    {
      icon: FileCheck,
      title: 'Finishing',
      description: 'Surface treatment and final quality assurance'
    }
  ];
  ...
  const materialExpertise = [
    ...
    },
    {
      ...
      properties: 'Lightweight, corrosion resistant, excellent strength-to-weight ratio'
    },
    {
      name: 'Brass',
      grades: ['C36000', 'C37700', 'C26000', 'C46400'],
      properties: 'Excellent machinability, corrosion resistance, antimicrobial'
    },
    {
      name: 'Copper',
      grades: ['C11000', 'C10100', 'C12200', 'C14500'],
      properties: 'High electrical conductivity, thermal conductivity, antimicrobial'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <h2 className="text-4xl font-bold text-white">Hot Forging Excellence</h2>
            </div>
          ...
          <div className="relative overflow-hidden rounded-2xl mb-12">
            ...
            <div className="absolute bottom-8 left-8">
              <h3 className="text-3xl font-bold text-white mb-2">Advanced Hot Forging Technology</h3>
              <p className="text-orange-300">Precision forging at 1000-1200°C for superior results</p>
            </div>
          </div>
        </div>
      </section>
            ...
            {hotForgingProcesses.map((process, index) => (
              ...
              >
                ...
                <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                  <div>
                    <h3 className="text-3xl font-bold text-black mb-4">{process.title}</h3>
                    <p className="text-lg text-gray-600 mb-6">{process.description}</p>
                  </div>

                  {/* Features */}
                  <div className="bg-white p-6 rounded-xl shadow-sm">
                    <h4 className="text-xl font-semibold text-black mb-4">Process Specifications</h4>
                  ...
                  <div className="bg-black p-6 rounded-xl text-white">
                    <h4 className="text-xl font-semibold text-orange-500 mb-4">Applications</h4>
                    <div className="grid md:grid-cols-2 gap-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">
              Hot Forging <span className="text-orange-500">Process Steps</span>
            </h2>
            <p className="text-xl text-gray-300">
              From cutting to finishing - our comprehensive forging process
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {processSteps.map((step, index) => (
              <div key={index} className="bg-gray-900 rounded-xl p-8 text-center relative">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-orange-500 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">
                  {index + 1}
                </div>
                <div className="bg-orange-500/10 w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-6 mt-4">
            ...
            {materialExpertise.map((material, index) => (
              <div key={index} className="bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-black mb-2">Available Grades:</h4>
                    <div className="flex flex-wrap gap-2">
                      {material.grades.map((grade, gradeIndex) => (
                        <span key={gradeIndex} className="bg-gray-100 text-gray-700 px-2 py-1 rounded text-sm">
                          {grade}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    <h4 className="font-semibold text-black mb-2">Properties:</h4>
                    <p className="text-gray-600 text-sm">{material.properties}</p>
                  </div>
                </div>
              </div>
            ))}
